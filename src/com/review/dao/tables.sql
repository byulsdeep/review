CREATE TABLE ACCOUNTS (
    ...
    ACT_TYPE    NUMBER(1) DEFAULT 1 NOT NULL -- 0 관리자, 1 고객
)
TABLESPACE USERS;
...
CREATE TABLE ACCESSLOG ( -- 접속 기록
    ...
    ASL_ACTION  NUMBER(1), -- 1 로그인 -1 로그아웃
...
CREATE TABLE PRODUCT ( -- 상품
    ...
    PRD_VISIBLE  NUMBER(1) DEFAULT 1 NOT NULL, -- 1 공개 0 비공개
...
CREATE TABLE VIEWHISTORY ( -- 조회기록, 위시리스트
    ...
    VHS_ISWISH  NUMBER(1) DEFAULT 0 NOT NULL, -- 1 위시리스트인 상품 , 0 아닌 상품
...
--CREATE PUBLIC SYNONYM MD FOR MADE;
